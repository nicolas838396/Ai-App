...
const FEATURES: { icon: typeof MessageCircleHeart; titleKey: TranslationKey; descKey: TranslationKey }[] = [
  ...
  { icon: NotebookPen, titleKey: "landing.feature2.title", descKey: "landing.feature2.desc" },
  { icon: Sparkles, titleKey: "landing.feature3.title", descKey: "landing.feature3.desc" },
  { icon: Wind, titleKey: "landing.feature4.title", descKey: "landing.feature4.desc" },
];
    ...
    <main className="min-h-screen bg-hero-gradient">
      ...
      <section className="mx-auto flex max-w-3xl flex-col items-center gap-6 px-6 pb-20 pt-10 text-center sm:pb-28 sm:pt-16">
        ...
        <h1 className="text-4xl leading-tight sm:text-5xl">
          ...
          <span className="text-brand-600">{t("landing.titleHighlight")}</span>
        </h1>
        <p className="max-w-xl text-lg text-slate-600">{t("landing.subtitle")}</p>
        <Link
          href="/login"
        ...
        <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
          {FEATURES.map((feature) => (
            ...
            >
              ...
              <h2 className="mt-4 font-bold text-slate-800">{t(feature.titleKey)}</h2>
      ...
      <footer className="mx-auto max-w-5xl px-6 pb-10 text-center text-xs text-slate-400">{t("landing.footer")}</footer>
    </main>
  );
}
